...
@section('contentAdmin')
                ...
                {!! Form::open(['action' => ['BooksController@update',$books->id],'method'=>'POST','id'=>'myform']) !!}
                <div class="row">
                <div class="form-group col-md-6 mb-3 ">
                    {{ Form::label('title', 'Title')}}
                    {{ Form::text('title', $books->title,['class' => 'form-control'])}}
                </div>
                <div class="form-group col-md-6 mb-3">
            ...
            <div class="row">
                <div class="form-group col-md-3 mb-3">
                    ...
                    {{ Form::text('quantity', $books->quantity,['class' => 'form-control'])}}
                </div>
                <div class="form-group col-md-3 mb-3">
                        {{ Form::label('publisher', 'Publisher')}}
                        {{ Form::text('publisher', $books->publisher,['class' => 'form-control'])}}
                    </div>
                <div class="form-group col-md-3 mb-3">
                    {{ Form::label('isbn', 'ISBN')}}
                    {{ Form::text('isbn', $books->isbn,['class' => 'form-control'])}}
                </div>
            ...
            <div class="form-group">
                ...
                {{ Form::text('image',$books->image,['class' => 'form-control'])}}
            </div>
        ...
        <script>
            var cat="{{$categories->name}}".toLowerCase().replace(/ +/g, "");
